...
@_BWDxS22Jjz = private global [17 x i8] c"Long live QUIX!\0A\00"
...
entry:
  ...
  %calltmp2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @_BWDxS22Jjz, i32 0, i32 0))
