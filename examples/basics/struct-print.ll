...
define private void @_ZJ0f12init__person41f1v34p31t6Person17t7Address1x1x1x1x1x1b1p1p(%Person.1* %person) {
entry:
...
define private void @_ZJ0f13print__person41f1v34p31t6Person17t7Address1x1x1x1x1x1b1p1p(%Person.1* %person) {
entry:
  %0 = getelementptr inbounds %Person.1, %Person.1* %person, i32 0, i32 1
...
entry:
  ...
  call void @_ZJ0f12init__person41f1v34p31t6Person17t7Address1x1x1x1x1x1b1p1p(%Person.1* %p)
  %1 = load %Person.1, %Person.1* %p, align 8
  call void @_ZJ0f13print__person41f1v34p31t6Person17t7Address1x1x1x1x1x1b1p1p(%Person.1* %p)
