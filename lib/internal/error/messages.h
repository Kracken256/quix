...
namespace libj
{
    enum Msg
    {
        ...
        STRUCT_DECL_EXPECTED_OPEN_BRACE,
        STRUCT_DECL_EXPECTED_CLOSE_BRACE,
        STRUCT_DECL_EXPECTED_SEMICOLON,
        STRUCT_DECL_MISSING_COLON,
        STRUCT_DECL_TYPE_ERR,
        STRUCT_DECL_INIT_ERR,
        STRUCT_DECL_MISSING_PUNCTOR,
        TYPE_EXPECTED_TYPE,
