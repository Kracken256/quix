...
namespace libj
{
    typedef bool (*MacroParserRoutine)(jcc_job_t *job, const std::string &directive, const std::string &parameter, std::vector<libj::Token> &exp);
    ...
    public:
        ...
        bool parse(const libj::Token &macro, std::vector<libj::Token> &exp) const;
    };
}
