#include <parse/nodes/const_expr.hpp>
...
llvm::Constant *libj::ConstUnaryExprNode::codegen(libj::LLVMContext &ctx) const
{
...
std::shared_ptr<libj::ParseNode> libj::ConstUnaryExprNode::clone() const
{
    return std::make_shared<ConstUnaryExprNode>(*this);
}

std::string libj::ConstBinaryExprNode::to_json() const
{
    std::string json = "{";
...
llvm::Constant *libj::ConstBinaryExprNode::codegen(libj::LLVMContext &ctx) const
{
...
std::shared_ptr<libj::ParseNode> libj::ConstBinaryExprNode::clone() const
{
