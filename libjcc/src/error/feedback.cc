...
std::map<libjcc::Msg, const char *> libjcc::feedback = {
    ...
    {UNION_FIELD_TYPE_ERR, "An error occurred while parsing the type of field '%s'. Syntax: name: type [= expr];"},
    {UNION_FIELD_MISSING_PUNCTOR, "Declaration of field '%s' requires an initializer OR a semicolon punctuator, but neither was found. Make sure to terminate all statements with a semicolon. Syntax: name: type [= expr];"},
