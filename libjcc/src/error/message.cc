...
static std::string make_parser_message_colored(const std::string &file, const libjcc::Token &tok, Err type, const std::string &format, va_list args)
{
...
static std::string make_parser_message_nocolor(const std::string &file, const libjcc::Token &tok, Err type, const std::string &format, va_list args)
{
    std::string msg = file + ":";
...
void libjcc::message(jcc_job_t &job, Err type, const std::string &format, ...)
{
    va_list args;
...
void libjcc::parmsg(jcc_job_t &job, const libjcc::Token &tok, libjcc::Err type, const std::string &format, ...)
{
    va_list args;
    va_start(args, format);
    std::string msg;
