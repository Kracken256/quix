...
LIB_EXPORT void ConstExpr::canonicalize_impl() {
...
LIB_EXPORT ConstExpr *ConstExpr::clone_impl() const {
...
LIB_EXPORT void ConstChar::print_impl(std::ostream &os, bool debug) const {
  ...
  throw std::runtime_error("ConstChar::print_impl not implemented");
  os << "'";
}
