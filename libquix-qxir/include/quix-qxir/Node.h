...
typedef enum qxir_ty_t {
  ...
  QIR_NODE_BINEXPR = 100,
  QIR_NODE_UNEXPR = 101,
  QIR_NODE_TEREXPR = 102,
  QIR_NODE_INT = 400,
  QIR_NODE_FLOAT = 401,
  QIR_NODE_STRING = 402,
  QIR_NODE_CHAR = 403,
  ...
  QIR_NODE_INDEX = 120,
  QIR_NODE_SLICE = 121,
  QIR_NODE_FSTRING = 122,
  QIR_NODE_IDENT = 123,
  QIR_NODE_SEQ_POINT = 124,
  QIR_NODE_POST_UNEXPR = 125,
  QIR_NODE_STMT_EXPR = 126,
  QIR_NODE_TYPE_EXPR = 127,
  QIR_NODE_TEMPL_CALL = 128,
  ...
  QIR_NODE_U32_TY = 304,
  QIR_NODE_U64_TY = 305,
  QIR_NODE_U128_TY = 306,
  QIR_NODE_I8_TY = 307,
  QIR_NODE_I16_TY = 308,
  QIR_NODE_I32_TY = 309,
  QIR_NODE_I64_TY = 310,
  QIR_NODE_I128_TY = 311,
  QIR_NODE_F32_TY = 312,
  QIR_NODE_F64_TY = 313,
  QIR_NODE_VOID_TY = 314,
  QIR_NODE_PTR_TY = 315,
  QIR_NODE_OPAQUE_TY = 316,
  QIR_NODE_STRING_TY = 317,
  QIR_NODE_ENUM_TY = 318,
  QIR_NODE_STRUCT_TY = 319,
  QIR_NODE_GROUP_TY = 320,
  QIR_NODE_REGION_TY = 321,
  QIR_NODE_UNION_TY = 322,
  QIR_NODE_ARRAY_TY = 323,
  QIR_NODE_VECTOR_TY = 324,
  QIR_NODE_MAP_TY = 325,
  QIR_NODE_TUPLE_TY = 326,
  QIR_NODE_SET_TY = 327,
  QIR_NODE_RESULT_TY = 328,
  QIR_NODE_FN_TY = 329,
  QIR_NODE_UNRES_TY = 330,

  QIR_NODE_TYPEDEF = 500,
  QIR_NODE_FNDECL = 501,
  QIR_NODE_STRUCT = 502,
  QIR_NODE_REGION = 504,
  QIR_NODE_GROUP = 506,
  ...
  QIR_NODE_ENUM = 510,
  QIR_NODE_FN = 512,
  QIR_NODE_SUBSYSTEM = 514,
  QIR_NODE_EXPORT = 515,
  QIR_NODE_COMPOSITE_FIELD = 516,

  QIR_NODE_BLOCK = 700,
  QIR_NODE_CONST = 701,
  QIR_NODE_VAR = 702,
  QIR_NODE_LET = 703,
  QIR_NODE_INLINE_ASM = 704,
  QIR_NODE_RETURN = 705,
  QIR_NODE_RETIF = 706,
  QIR_NODE_RETZ = 707,
  QIR_NODE_RETV = 708,
  QIR_NODE_BREAK = 709,
  QIR_NODE_CONTINUE = 710,
  QIR_NODE_IF = 711,
  QIR_NODE_WHILE = 712,
  QIR_NODE_FOR = 713,
  QIR_NODE_FORM = 714,
  QIR_NODE_FOREACH = 715,
  QIR_NODE_CASE = 716,
  QIR_NODE_SWITCH = 717,
  QIR_NODE_SLIST = 718,
  QIR_NODE_EXPR_STMT = 719,
  QIR_NODE_VOLSTMT = 720,
} qxir_ty_t;

#define QIR_NODE_COUNT 91

typedef enum qxir_ftype_t {
  QIR_FIELD_BOOL = 0,
  QIR_FIELD_CHAR = 1,
  QIR_FIELD_INT8 = 2,
  QIR_FIELD_INT16 = 3,
...
namespace qxir {
  ...
  public:
    ...
    bool is(const qxir_ty_t type) const;
    bool verify(std::ostream &os = std::cerr) const;
    void canonicalize();
    virtual Node *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;

    static const char *type_name(qxir_ty_t type);
  ...
  public:
    ...
    virtual Stmt *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual Type *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual Decl *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual Expr *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual LitExpr *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual FlowStmt *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual DeclStmt *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual TypeBuiltin *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual TypeComplex *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    virtual TypeComposite *clone(ArenaAllocatorImpl &arena = qxir_arena) const = 0;
  };
  ...
  public:
    ...
    QNODE_IMPL_CORE(UnresolvedType)
  };
  ...
  public:
    ...
    QNODE_IMPL_CORE(CompositeField)
  };
...
namespace std {
  ...
  std::ostream &operator<<(std::ostream &os, const qlex_op_t &op);
  std::ostream &operator<<(std::ostream &os, const qxir::FuncPurity &purity);
}  // namespace std
