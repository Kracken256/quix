    ...
    namespace ir
    {
        namespace beta
        {
            ...
            protected:
                ...
                {
                    return "Quix Beta Intermediate Representation (QIR-Beta-V1.0) is a high-level intermediate representation for the Quix language. It contains high level information such as control flow, lambda expressions, coroutines, heap allocations, and other high-level constructs.";
                }
