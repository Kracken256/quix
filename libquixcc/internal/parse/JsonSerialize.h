...
namespace libquixcc
{
    ...
    public:
        ...
        std::string visit(const ListExprNode *node) const;
        std::string visit(const MemberAccessNode *node) const;
        ...
        std::string visit(const MutTypeNode *node) const;
        ...
        std::string visit(const OpaqueTypeNode *node) const;
        ...
        std::string visit(const RegionTypeNode *node) const;
        ...
        std::string visit(const RegionDefNode *node) const;
        std::string visit(const RegionFieldNode *node) const;
        ...
        std::string visit(const InlineAsmNode *node) const;
