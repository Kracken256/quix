    ...
    public:
        ...
        bool isof() const
        {
            ...
            if (std::is_same_v<T, LiteralNode>)
                return is<IntegerNode>() || is<FloatLiteralNode>() || is<StringNode>() || is<CharNode>() || is<BoolLiteralNode>() || is<NullLiteralNode>() || is<UndefLiteralNode>();
            ...
            if (std::is_same_v<T, TypeNode>)
                return is<MutTypeNode>() || is<U8TypeNode>() || is<U16TypeNode>() || is<U32TypeNode>() || is<U64TypeNode>() || is<U128TypeNode>() || is<I8TypeNode>() || is<I16TypeNode>() || is<I32TypeNode>() || is<I64TypeNode>() || is<I128TypeNode>() || is<F32TypeNode>() || is<F64TypeNode>() || is<BoolTypeNode>() || is<VoidTypeNode>() || is<NullTypeNode>() || is<PointerTypeNode>() || is<OpaqueTypeNode>() || is<StringTypeNode>() || is<EnumTypeNode>() || is<StructTypeNode>() || is<RegionTypeNode>() || is<UnionTypeNode>() || is<ArrayTypeNode>() || is<VectorTypeNode>() || is<ResultTypeNode>() || is<GeneratorTypeNode>() || is<FunctionTypeNode>() || is<UserTypeNode>();
