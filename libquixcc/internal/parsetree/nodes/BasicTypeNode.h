...
class MutTypeNode : public TypeNode {
 ...
 public:
  static MutTypeNode *create(TypeNode *type) {
    ...
    if (!m_instances.contains(type)) m_instances[type] = new MutTypeNode(type);
...
class U8TypeNode : public TypeNode {
 ...
 public:
  static U8TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new U8TypeNode();
    return m_instance;
  }
};
...
class U16TypeNode : public TypeNode {
 ...
 public:
  static U16TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new U16TypeNode();
    return m_instance;
  }
};
...
class U32TypeNode : public TypeNode {
 ...
 public:
  static U32TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new U32TypeNode();
    return m_instance;
  }
};
...
class U64TypeNode : public TypeNode {
 ...
 public:
  static U64TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new U64TypeNode();
    return m_instance;
  }
};
...
class U128TypeNode : public TypeNode {
 ...
 public:
  static U128TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new U128TypeNode();
    return m_instance;
  }
};
...
class I8TypeNode : public TypeNode {
 ...
 public:
  static I8TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new I8TypeNode();
    return m_instance;
  }
};
...
class I16TypeNode : public TypeNode {
 ...
 public:
  static I16TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new I16TypeNode();
    return m_instance;
  }
};
...
class I32TypeNode : public TypeNode {
 ...
 public:
  static I32TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new I32TypeNode();
    return m_instance;
  }
};
...
class I64TypeNode : public TypeNode {
 ...
 public:
  static I64TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new I64TypeNode();
    return m_instance;
  }
};
...
class I128TypeNode : public TypeNode {
 ...
 public:
  static I128TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new I128TypeNode();
    return m_instance;
  }
};
...
class F32TypeNode : public TypeNode {
 ...
 public:
  static F32TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new F32TypeNode();
    return m_instance;
  }
};
...
class F64TypeNode : public TypeNode {
 ...
 public:
  static F64TypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new F64TypeNode();
    return m_instance;
  }
};
...
class BoolTypeNode : public TypeNode {
 ...
 public:
  static BoolTypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new BoolTypeNode();
    return m_instance;
  }
};
...
class VoidTypeNode : public TypeNode {
 ...
 public:
  static VoidTypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new VoidTypeNode();
    return m_instance;
  }
};
...
class NullTypeNode : public TypeNode {
 ...
 public:
  static NullTypeNode *create() {
    ...
    if (m_instance == nullptr) m_instance = new NullTypeNode();
    return m_instance;
  }
};
