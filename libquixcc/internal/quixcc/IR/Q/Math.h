...
protected:
    ...
    BitAnd(Expr *lhs, Expr *rhs) : lhs(lhs), rhs(rhs) { ntype = (int)QType::BitAnd; }
...
protected:
    ...
    BitOr(Expr *lhs, Expr *rhs) : lhs(lhs), rhs(rhs) { ntype = (int)QType::BitOr; }
...
protected:
    ...
    BitXor(Expr *lhs, Expr *rhs) : lhs(lhs), rhs(rhs) { ntype = (int)QType::BitXor; }
