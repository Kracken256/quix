...
namespace libquixcc {
  namespace ir {
    ...
    protected:
        ...
        RootNode(std::vector<Value *> children) : children(children) { ntype = (int)QType::Root; }
    ...
    public:
        ...
        /*========================== ITERATION ==========================*/
        void dft_iter(IterFunc func, PredFunc predicate = nullptr, bool post_order = false);

        void bft_iter(IterFunc func, PredFunc predicate = nullptr, bool post_order = false);
