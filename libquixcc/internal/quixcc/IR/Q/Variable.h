...
protected:
    ...
    Local(std::string name, Type *type, Expr *value) : name(name), type(type), value(value) {
...
protected:
    ...
    Global(std::string name, Type *type, Expr *value, bool _volatile, bool _atomic, bool _extern)
        : name(name), type(type), value(value), _volatile(_volatile), _atomic(_atomic),
          _extern(_extern) {
      ntype = (int)QType::Global;
    }

public:
    static Global *create(std::string name, Type *type, Expr *value, bool _volatile = false,
...
protected:
    ...
    List(std::vector<Expr *> values) : values(values) { ntype = (int)QType::List; }
