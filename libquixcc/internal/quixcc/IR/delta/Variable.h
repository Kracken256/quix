...
protected:
    ...
    Global(std::string name, const Type *type, const Expr *value, bool _volatile, bool _atomic,
           bool _extern)
...
public:
    static const Global *create(std::string name, const Type *type, const Expr *value,
...
protected:
    ...
    List(std::vector<const Expr *> values) : values(values) { ntype = (int)NodeType::List; }
