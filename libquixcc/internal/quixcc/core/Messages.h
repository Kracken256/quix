...
namespace libquixcc {
  enum Msg {
    ...
    STRUCT_DEF_EXPECTED_OPEN_BRACKET,
    STRUCT_DEF_EXPECTED_IDENTIFIER,
    ...
    REGION_DEF_EXPECTED_OPEN_BRACKET,
    REGION_DEF_EXPECTED_IDENTIFIER,
    ...
    GROUP_DEF_EXPECTED_OPEN_BRACKET,
    GROUP_DEF_EXPECTED_IDENTIFIER,
    ...
    UNION_DEF_EXPECTED_OPEN_BRACKET,
    UNION_DEF_EXPECTED_IDENTIFIER,
    ...
    FN_EXPECTED_IN_OUT,
    FN_DEF_EXPECTED_OPEN_BRACKET,
    FN_DEF_EXPECTED_IDENTIFIER,
