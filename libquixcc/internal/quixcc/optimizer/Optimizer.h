...
namespace libquixcc {
  namespace optimizer {
    typedef bool (*OptPassFunc)(quixcc_cc_job_t &job, std::unique_ptr<ir::q::QModule> &ir);
  ...
  public:
      ...
      inline const std::vector<OptPassUUID> &prepass_suggests() const { return m_prepass_suggests; }
  ...
  public:
      OptPassManager(std::shared_ptr<OptPassRegistry> registry) : m_registry(registry) {}
