...
public:
    ArrayTypeNode(std::shared_ptr<TypeNode> type, std::shared_ptr<ConstExprNode> size)
...
public:
    MapTypeNode(std::shared_ptr<TypeNode> key_type, std::shared_ptr<TypeNode> value_type)
...
public:
    SetTypeNode(std::shared_ptr<TypeNode> type) : m_type(type) { ntype = NodeType::SetTypeNode; }
