...
bool libquixcc::ir::q::BitAnd::print_impl(std::ostream &os,
                                          PState &state) const {
  os << "(";
  if (!lhs->print(os, state)) return false;
  os << "&";
...
bool libquixcc::ir::q::BitOr::print_impl(std::ostream &os,
                                         PState &state) const {
  os << "(";
  if (!lhs->print(os, state)) return false;
  os << "|";
...
bool libquixcc::ir::q::BitXor::print_impl(std::ostream &os,
                                          PState &state) const {
  os << "(";
  if (!lhs->print(os, state)) return false;
  os << "^";
...
bool libquixcc::ir::q::BitNot::print_impl(std::ostream &os,
                                          PState &state) const {
  os << "(~";
