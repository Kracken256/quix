...
libquixcc::Feedback libquixcc::feedback({
    ...
    {ASM_EXPECTED_LEFT_PAREN, "Expected an open parenthesis after the keyword '__asm__'. Syntax: __asm__ ( ... );"},
    {ASM_EXPECTED_STRING_LITERAL, "Expected a string literal in the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_COMMA, "Expected a comma after the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_OUTPUTS, "Expected an outputs list in the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_INPUTS, "Expected an inputs list in the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_CLOBBERS, "Expected a clobbers list in the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_RIGHT_PAREN, "Expected a closing parenthesis after the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_SEMICOLON, "Expected a semicolon after the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_LEFT_BRACE, "Expected an open brace after the inline assembly statement. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_PARAM_EXPECTED_STRING_LITERAL, "Expected a string literal in the inline assembly parameter list. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_PARAM_EXPECTED_COLON, "Expected a colon after the string literal in the inline assembly parameter list. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_PARAM_EXPECTED_EXPR, "Expected an expression after the colon in the inline assembly parameter list. Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
