...
namespace libquixcc
{
    std::map<std::string, libquixcc::Keyword> keyword_map = {
        ...
        {"packet", libquixcc::Keyword::Packet},
        ...
        {"volatile", libquixcc::Keyword::Volatile},
        {"enum", libquixcc::Keyword::Enum},
        {"class", libquixcc::Keyword::Class},
        {"bundle", libquixcc::Keyword::Bundle},
        {"pub", libquixcc::Keyword::Pub},
        {"private", libquixcc::Keyword::Private},
        {"protected", libquixcc::Keyword::Protected},
        {"override", libquixcc::Keyword::Override},
        {"virtual", libquixcc::Keyword::Virtual},
        {"abstract", libquixcc::Keyword::Abstract},
        {"friend", libquixcc::Keyword::Friend},
        {"interface", libquixcc::Keyword::Interface},
        {"delete", libquixcc::Keyword::Delete},
        ...
        {"abortif", libquixcc::Keyword::Abortif},
    ...
    std::map<libquixcc::Keyword, std::string> keyword_map_inverse = {
        ...
        {libquixcc::Keyword::Packet, "packet"},
        ...
        {libquixcc::Keyword::Volatile, "volatile"},
        {libquixcc::Keyword::Enum, "enum"},
        {libquixcc::Keyword::Class, "class"},
        {libquixcc::Keyword::Bundle, "bundle"},
        {libquixcc::Keyword::Pub, "pub"},
        {libquixcc::Keyword::Private, "private"},
        {libquixcc::Keyword::Protected, "protected"},
        {libquixcc::Keyword::Override, "override"},
        {libquixcc::Keyword::Virtual, "virtual"},
        {libquixcc::Keyword::Abstract, "abstract"},
        {libquixcc::Keyword::Friend, "friend"},
        {libquixcc::Keyword::Interface, "interface"},
        {libquixcc::Keyword::Delete, "delete"},
        ...
        {libquixcc::Keyword::Abortif, "abortif"},
    ...
    std::map<std::string, libquixcc::Operator> operator_map = {
        ...
        {"&", libquixcc::Operator::BitAnd},
        {"|", libquixcc::Operator::BitOr},
        {"^", libquixcc::Operator::BitXor},
        {"~", libquixcc::Operator::BitNot},
        ...
        {"|=", libquixcc::Operator::BitOrAssign},
        {"&=", libquixcc::Operator::BitAndAssign},
        {"^=", libquixcc::Operator::BitXorAssign},
