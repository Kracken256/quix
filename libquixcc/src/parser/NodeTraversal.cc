...
size_t libquixcc::ParseNodePreorderVisitor::visit(libquixcc::ListExprNode *node)
{
    ...
    {
        m_callback(m_prefix, node, reinterpret_cast<std::shared_ptr<libquixcc::ParseNode> *>(&elem));
...
size_t libquixcc::ParseNodePreorderVisitor::visit(libquixcc::FunctionTypeNode *node)
{
    ...
    {
        m_callback(m_prefix, node, reinterpret_cast<std::shared_ptr<libquixcc::ParseNode> *>(&param.second));
...
size_t libquixcc::ParseNodePreorderVisitor::visit(libquixcc::StructDefNode *node)
{
    ...
    {
        m_callback(m_prefix, node, reinterpret_cast<std::shared_ptr<libquixcc::ParseNode> *>(&method));
