...
std::unordered_map<libquixcc::NodeType, std::string_view>
    libquixcc::NodeTypeNames = {
        ...
        {NodeType::ConstPostUnaryExprNode, "ConstPostUnaryExprNode"},
        ...
        {NodeType::GeneratorTypeNode, "GeneratorTypeNode"},
        ...
        {NodeType::UndefLiteralNode, "UndefLiteralNode"},
        ...
        {NodeType::BreakStmtNode, "BreakStmtNode"},
        {NodeType::ContinueStmtNode, "ContinueStmtNode"},
        ...
        {NodeType::ForeachStmtNode, "ForeachStmtNode"},
        {NodeType::CaseStmtNode, "CaseStmtNode"},
        {NodeType::SwitchStmtNode, "SwitchStmtNode"},
};