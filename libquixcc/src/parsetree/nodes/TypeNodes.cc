...
thread_local std::map<libquixcc::TypeNode *, libquixcc::ResultTypeNode *> libquixcc::ResultTypeNode::m_instances;
thread_local std::map<libquixcc::TypeNode *, libquixcc::GeneratorTypeNode *> libquixcc::GeneratorTypeNode::m_instances;
