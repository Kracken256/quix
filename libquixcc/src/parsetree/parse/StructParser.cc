...
static bool parse_struct_field(quixcc_job_t &job, libquixcc::Scanner *scanner,
  ...
  if (tok.is<Punctor>(Punctor::Comma)) {
    ...
    LOG(ERROR) << feedback[STRUCT_FIELD_MISSING_PUNCTOR] << name << tok
               << std::endl;
    return false;
  }
...
bool libquixcc::parse_struct(quixcc_job_t &job, libquixcc::Scanner *scanner,
