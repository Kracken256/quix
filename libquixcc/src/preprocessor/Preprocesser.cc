...
libquixcc::PrepEngine::Entry libquixcc::PrepEngine::build_statics_decl()
{
    ...
    {
        message(*job, Err::DEBUG, "Adding static declaration: %s = %s", statics.first.c_str(), statics.second.c_str());
...
bool libquixcc::PrepEngine::handle_import()
{
    ...
    if (tok.is<Punctor>(Punctor::OpenParen))
    {
        ...
        {
            PREPMSG(tok, Err::ERROR, "Expected identifier or integer literal after import");
            return false;
        }
