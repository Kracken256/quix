...
bool QModule::print_impl(std::ostream &os, PState &state) const {
  if (state.modinfo) {
    ...
    for (size_t i = 0; i < m_passes.at(QPassType::Solver).size(); i++) {
      ...
      if (i < m_passes.at(QPassType::Solver).size() - 1)
        os << ", ";
    }
    os << "]\n";
    ...
    for (size_t i = 0; i < m_passes.at(QPassType::Optimizer).size(); i++) {
      ...
      if (i < m_passes.at(QPassType::Optimizer).size() - 1)
        os << ", ";
    }
...
void QModule::dft_iter(QModule::IterFunc func, QModule::PredFunc predicate, bool post_order) {
  ...
  auto push_children = [&stack](Value **val) -> bool {
    ...
    case QType::Ptr:
      ...
      break;
    case QType::Array:
      stack.push(reinterpret_cast<Value **>(&static_cast<Array *>(*val)->type));
      break;
    case QType::Vector:
      stack.push(reinterpret_cast<Value **>(&static_cast<Vector *>(*val)->type));
      break;
    case QType::FType:
      stack.push(reinterpret_cast<Value **>(&static_cast<FType *>(*val)->ret));
    ...
    case QType::Segment:
      ...
      stack.push(reinterpret_cast<Value **>(&static_cast<Segment *>(*val)->block));
      stack.push(reinterpret_cast<Value **>(&static_cast<Segment *>(*val)->return_type));
      break;
    case QType::Asm:
    ...
    case QType::UnionDef:
      ...
      break;
    case QType::SCast:
      stack.push(reinterpret_cast<Value **>(&static_cast<SCast *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<SCast *>(*val)->value));
      break;
    case QType::UCast:
      stack.push(reinterpret_cast<Value **>(&static_cast<UCast *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<UCast *>(*val)->value));
      break;
    case QType::PtrICast:
      stack.push(reinterpret_cast<Value **>(&static_cast<PtrICast *>(*val)->value));
      break;
    case QType::IPtrCast:
      stack.push(reinterpret_cast<Value **>(&static_cast<IPtrCast *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<IPtrCast *>(*val)->value));
      break;
    case QType::Bitcast:
      stack.push(reinterpret_cast<Value **>(&static_cast<Bitcast *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<Bitcast *>(*val)->value));
      break;
    case QType::Call:
      for (auto &child : static_cast<Call *>(*val)->args) {
        stack.push(reinterpret_cast<Value **>(&child));
      }
      stack.push(reinterpret_cast<Value **>(&static_cast<Call *>(*val)->func));
      break;
    case QType::CallIndirect:
      for (auto &child : static_cast<CallIndirect *>(*val)->args) {
        stack.push(reinterpret_cast<Value **>(&child));
      }
      stack.push(reinterpret_cast<Value **>(&static_cast<CallIndirect *>(*val)->exprfunc));
      break;
    case QType::IfElse:
      stack.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->cond));
      stack.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->then));
      stack.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->els));
      break;
    case QType::While:
      stack.push(reinterpret_cast<Value **>(&static_cast<While *>(*val)->cond));
      stack.push(reinterpret_cast<Value **>(&static_cast<While *>(*val)->body));
      break;
    case QType::For:
      ...
      break;
    case QType::Loop:
      stack.push(reinterpret_cast<Value **>(&static_cast<Loop *>(*val)->body));
      break;
    case QType::Break:
      break;
    case QType::Continue:
      break;
    case QType::Ret:
      stack.push(reinterpret_cast<Value **>(&static_cast<Ret *>(*val)->value));
      break;
    case QType::Throw:
      stack.push(reinterpret_cast<Value **>(&static_cast<Throw *>(*val)->value));
      break;
    case QType::TryCatchFinally:
      stack.push(reinterpret_cast<Value **>(&static_cast<TryCatchFinally *>(*val)->tryblock));
      for (auto &child : static_cast<TryCatchFinally *>(*val)->catchblocks) {
        stack.push(reinterpret_cast<Value **>(&child.first));
        stack.push(reinterpret_cast<Value **>(&child.second));
      }
      stack.push(reinterpret_cast<Value **>(&static_cast<TryCatchFinally *>(*val)->finallyblock));
      break;
    case QType::Case:
      stack.push(reinterpret_cast<Value **>(&static_cast<Case *>(*val)->value));
      stack.push(reinterpret_cast<Value **>(&static_cast<Case *>(*val)->body));
      break;
    case QType::Switch:
      stack.push(reinterpret_cast<Value **>(&static_cast<Switch *>(*val)->value));
      for (auto &child : static_cast<Switch *>(*val)->cases) {
        stack.push(reinterpret_cast<Value **>(&child));
      }
      stack.push(reinterpret_cast<Value **>(&static_cast<Switch *>(*val)->defaultcase));
      break;
    case QType::Ident:
      stack.push(reinterpret_cast<Value **>(&static_cast<Ident *>(*val)->type));
      break;
    case QType::Add:
    ...
    case QType::Mod:
      ...
      break;
    case QType::BitAnd:
      stack.push(reinterpret_cast<Value **>(&static_cast<BitAnd *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<BitAnd *>(*val)->rhs));
      break;
    case QType::BitOr:
      stack.push(reinterpret_cast<Value **>(&static_cast<BitOr *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<BitOr *>(*val)->rhs));
      break;
    case QType::BitXor:
      stack.push(reinterpret_cast<Value **>(&static_cast<BitXor *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<BitXor *>(*val)->rhs));
      break;
    case QType::BitNot:
      stack.push(reinterpret_cast<Value **>(&static_cast<BitNot *>(*val)->operand));
      break;
    case QType::Shl:
    ...
    case QType::Or:
      ...
      break;
    case QType::Not:
      stack.push(reinterpret_cast<Value **>(&static_cast<Not *>(*val)->operand));
      break;
    case QType::Xor:
      ...
      break;
    case QType::Local:
      stack.push(reinterpret_cast<Value **>(&static_cast<Local *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<Local *>(*val)->value));
      break;
    case QType::Global:
      stack.push(reinterpret_cast<Value **>(&static_cast<Global *>(*val)->type));
      stack.push(reinterpret_cast<Value **>(&static_cast<Global *>(*val)->value));
      break;
    case QType::Number:
    case QType::String:
    case QType::Char:
    ...
    case QType::List:
      ...
      break;
    case QType::Assign:
      stack.push(reinterpret_cast<Value **>(&static_cast<Assign *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<Assign *>(*val)->rhs));
      break;
    case QType::PostInc:
      stack.push(reinterpret_cast<Value **>(&static_cast<PostInc *>(*val)->lhs));
      break;
    case QType::PostDec:
      stack.push(reinterpret_cast<Value **>(&static_cast<PostDec *>(*val)->lhs));
      break;
    case QType::AddressOf:
      stack.push(reinterpret_cast<Value **>(&static_cast<AddressOf *>(*val)->lhs));
      break;
    case QType::Deref:
      stack.push(reinterpret_cast<Value **>(&static_cast<Deref *>(*val)->lhs));
      break;
    case QType::Member:
      stack.push(reinterpret_cast<Value **>(&static_cast<Member *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<Member *>(*val)->field_type));
      break;
    case QType::Index:
      stack.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->lhs));
      stack.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->index));
      stack.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->type));
      break;
    case QType::IntrinsicCall:
...
void QModule::bft_iter(QModule::IterFunc func, QModule::PredFunc predicate, bool post_order) {
  /// TODO: TEST THIS CRITICAL FUNCTION
  ...
  auto enqueue_children = [&queue](Value **val) -> bool {
    ...
    case QType::Ptr:
      ...
      break;
    case QType::Array:
      queue.push(reinterpret_cast<Value **>(&static_cast<Array *>(*val)->type));
      break;
    case QType::Vector:
      queue.push(reinterpret_cast<Value **>(&static_cast<Vector *>(*val)->type));
      break;
    case QType::FType:
      queue.push(reinterpret_cast<Value **>(&static_cast<FType *>(*val)->ret));
      for (auto &arg : static_cast<FType *>(*val)->params) {
    ...
    case QType::Segment:
      ...
      queue.push(reinterpret_cast<Value **>(&static_cast<Segment *>(*val)->block));
      queue.push(reinterpret_cast<Value **>(&static_cast<Segment *>(*val)->return_type));
      break;
    case QType::Asm:
      for (auto &child : static_cast<Asm *>(*val)->inputs) {
        queue.push(reinterpret_cast<Value **>(&child));
    ...
    case QType::UnionDef:
      ...
      break;
    case QType::SCast:
      queue.push(reinterpret_cast<Value **>(&static_cast<SCast *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<SCast *>(*val)->value));
      break;
    case QType::UCast:
      queue.push(reinterpret_cast<Value **>(&static_cast<UCast *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<UCast *>(*val)->value));
      break;
    case QType::PtrICast:
      queue.push(reinterpret_cast<Value **>(&static_cast<PtrICast *>(*val)->value));
      break;
    case QType::IPtrCast:
      queue.push(reinterpret_cast<Value **>(&static_cast<IPtrCast *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<IPtrCast *>(*val)->value));
      break;
    case QType::Bitcast:
      queue.push(reinterpret_cast<Value **>(&static_cast<Bitcast *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<Bitcast *>(*val)->value));
      break;
    case QType::Call:
      for (auto &child : static_cast<Call *>(*val)->args) {
        queue.push(reinterpret_cast<Value **>(&child));
      }
      queue.push(reinterpret_cast<Value **>(&static_cast<Call *>(*val)->func));
      break;
    case QType::CallIndirect:
      for (auto &child : static_cast<CallIndirect *>(*val)->args) {
        queue.push(reinterpret_cast<Value **>(&child));
      }
      queue.push(reinterpret_cast<Value **>(&static_cast<CallIndirect *>(*val)->exprfunc));
      break;
    case QType::IfElse:
      queue.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->cond));
      queue.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->then));
      queue.push(reinterpret_cast<Value **>(&static_cast<IfElse *>(*val)->els));
      break;
    case QType::While:
      queue.push(reinterpret_cast<Value **>(&static_cast<While *>(*val)->cond));
      queue.push(reinterpret_cast<Value **>(&static_cast<While *>(*val)->body));
      break;
    case QType::For:
      ...
      break;
    case QType::Loop:
      queue.push(reinterpret_cast<Value **>(&static_cast<Loop *>(*val)->body));
      break;
    case QType::Break:
      break;
    case QType::Continue:
      break;
    case QType::Ret:
      queue.push(reinterpret_cast<Value **>(&static_cast<Ret *>(*val)->value));
      break;
    case QType::Throw:
      queue.push(reinterpret_cast<Value **>(&static_cast<Throw *>(*val)->value));
      break;
    case QType::TryCatchFinally:
      queue.push(reinterpret_cast<Value **>(&static_cast<TryCatchFinally *>(*val)->tryblock));
      for (auto &child : static_cast<TryCatchFinally *>(*val)->catchblocks) {
        queue.push(reinterpret_cast<Value **>(&child.first));
        queue.push(reinterpret_cast<Value **>(&child.second));
      }
      queue.push(reinterpret_cast<Value **>(&static_cast<TryCatchFinally *>(*val)->finallyblock));
      break;
    case QType::Case:
      queue.push(reinterpret_cast<Value **>(&static_cast<Case *>(*val)->value));
      queue.push(reinterpret_cast<Value **>(&static_cast<Case *>(*val)->body));
      break;
    case QType::Switch:
      queue.push(reinterpret_cast<Value **>(&static_cast<Switch *>(*val)->value));
      for (auto &child : static_cast<Switch *>(*val)->cases) {
        queue.push(reinterpret_cast<Value **>(&child));
      }
      queue.push(reinterpret_cast<Value **>(&static_cast<Switch *>(*val)->defaultcase));
      break;
    case QType::Ident:
      queue.push(reinterpret_cast<Value **>(&static_cast<Ident *>(*val)->type));
      break;
    case QType::Add:
    ...
    case QType::Mod:
      ...
      break;
    case QType::BitAnd:
      queue.push(reinterpret_cast<Value **>(&static_cast<BitAnd *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<BitAnd *>(*val)->rhs));
      break;
    case QType::BitOr:
      queue.push(reinterpret_cast<Value **>(&static_cast<BitOr *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<BitOr *>(*val)->rhs));
      break;
    case QType::BitXor:
      queue.push(reinterpret_cast<Value **>(&static_cast<BitXor *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<BitXor *>(*val)->rhs));
      break;
    case QType::BitNot:
      queue.push(reinterpret_cast<Value **>(&static_cast<BitNot *>(*val)->operand));
      break;
    case QType::Shl:
    ...
    case QType::Or:
      ...
      break;
    case QType::Not:
      queue.push(reinterpret_cast<Value **>(&static_cast<Not *>(*val)->operand));
      break;
    case QType::Xor:
      ...
      break;
    case QType::Local:
      queue.push(reinterpret_cast<Value **>(&static_cast<Local *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<Local *>(*val)->value));
      break;
    case QType::Global:
      queue.push(reinterpret_cast<Value **>(&static_cast<Global *>(*val)->type));
      queue.push(reinterpret_cast<Value **>(&static_cast<Global *>(*val)->value));
      break;
    case QType::Number:
    case QType::String:
    case QType::Char:
    ...
    case QType::List:
      ...
      break;
    case QType::Assign:
      queue.push(reinterpret_cast<Value **>(&static_cast<Assign *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<Assign *>(*val)->rhs));
      break;
    case QType::PostInc:
      queue.push(reinterpret_cast<Value **>(&static_cast<PostInc *>(*val)->lhs));
      break;
    case QType::PostDec:
      queue.push(reinterpret_cast<Value **>(&static_cast<PostDec *>(*val)->lhs));
      break;
    case QType::AddressOf:
      queue.push(reinterpret_cast<Value **>(&static_cast<AddressOf *>(*val)->lhs));
      break;
    case QType::Deref:
      queue.push(reinterpret_cast<Value **>(&static_cast<Deref *>(*val)->lhs));
      break;
    case QType::Member:
      queue.push(reinterpret_cast<Value **>(&static_cast<Member *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<Member *>(*val)->field_type));
      break;
    case QType::Index:
      queue.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->lhs));
      queue.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->index));
      queue.push(reinterpret_cast<Value **>(&static_cast<Index *>(*val)->type));
      break;
    case QType::IntrinsicCall:
      for (auto &child : static_cast<IntrinsicCall *>(*val)->args) {
        queue.push(reinterpret_cast<Value **>(&child));
...
Value *QModule::dfs_find_first(QModule::MatchFunc match, QModule::PredFunc predicate,
                               bool post_order) {
  /// TODO: Test this code !!!
...
Value *QModule::bfs_find_first(QModule::MatchFunc match, QModule::PredFunc predicate,
                               bool post_order) {
  /// TODO: Test this code !!!
  Value *result = nullptr;
...
void QModule::dfs_find_all(QModule::MatchFunc match, std::vector<Value *> &results,
...
void QModule::bfs_find_all(QModule::MatchFunc match, std::vector<Value *> &results,
                           QModule::PredFunc predicate, bool post_order) {
  assert(match != nullptr);
