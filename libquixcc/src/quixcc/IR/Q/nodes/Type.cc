...
boost::uuids::uuid libquixcc::ir::q::I1::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I1::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::I8::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I8::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::I16::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I16::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::I32::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I32::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::I64::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I64::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::I128::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::I128::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::U8::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::U8::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::U16::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::U16::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::U32::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::U32::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::U64::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::U64::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::U128::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::U128::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::F32::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::F32::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::F64::hash_impl() const { return Hasher().gettag().hash(); }

bool libquixcc::ir::q::F64::verify_impl() const { return true; }

boost::uuids::uuid libquixcc::ir::q::Void::hash_impl() const { return Hasher().gettag().hash(); }
...
bool libquixcc::ir::q::Array::verify_impl() const { return type->verify() && size > 0; }
...
boost::uuids::uuid libquixcc::ir::q::Region::hash_impl() const {
  return Hasher().gettag().add(name).add(fields).add(m_packed).add(m_ordered).hash();
}
...
size_t libquixcc::ir::q::Type::size() const { return std::ceil(bitcount() / 8.0); }
...
bool libquixcc::ir::q::Type::is_float() const { return this->is<F32>() || this->is<F64>(); }
