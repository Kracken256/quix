...
// struct QState {
//   std::map<std::string, std::pair<ExportLang, QResult>> exported;
...
//   auto tmp =
//       Global::create(n->m_name, type, expr, false, false, state.lang != ExportLang::None);
//   std::string mangled = Symbol::mangle(
//       tmp, "", state.lang == ExportLang::None ? ExportLang::Default : state.lang);
//   auto g = Global::create(mangled, type, expr, false, false, state.lang != ExportLang::None);
...
//   if (n->m_name == "main") {
//     g = Global::create(mangled = Symbol::mangle(g, "", ExportLang::C), seg->infer(), seg, false,
//                        false, true);
//   } else {
//     if (state.lang == ExportLang::None) {
//       g = Global::create(mangled = Symbol::mangle(g, "", ExportLang::Default), seg->infer(),
