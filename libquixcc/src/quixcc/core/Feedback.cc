...
libquixcc::core::Feedback libquixcc::core::feedback({
    {PARSER_EXPECTED_KEYWORD, "Parser failed because a keyword was expected, but the token {} was "
                              "found"},
    ...
    {LET_DECL_MISSING_COLON,
     ...
     "name: type [= expr];"},
    {LET_DECL_TYPE_ERR, "An error occurred while parsing the type of variable '{}'. Syntax: let "
                        "name: type [= expr];"},
    {LET_DECL_INIT_ERR, "Declaration of variable '{}' requires an initializer, but an error "
    ...
    {CONST_DECL_TYPE_ERR,
     ...
     "name: type [= expr];"},
    {CONST_DECL_INIT_ERR, "Declaration of variable '{}' requires an initializer, but an error "
    ...
    {VAR_DECL_MISSING_COLON,
     ...
     "name: type [= expr];"},
    {VAR_DECL_TYPE_ERR, "An error occurred while parsing the type of variable '{}'. Syntax: var "
                        "name: type [= expr];"},
    {VAR_DECL_INIT_ERR, "Declaration of variable '{}' requires an initializer, but an error "
    ...
    {STRUCT_FIELD_MISSING_COLON,
     ...
     "type [= expr];"},
    {STRUCT_FIELD_TYPE_ERR, "An error occurred while parsing the type of field '{}'. Syntax: name: "
                            "type [= expr];"},
    ...
    {REGION_FIELD_MISSING_COLON,
     ...
     "insert a colon between the field name and the typename. Syntax: name: "
     "type [= expr];"},
    {REGION_FIELD_TYPE_ERR, "An error occurred while parsing the type of field '{}'. Syntax: name: "
                            "type [= expr];"},
    ...
    {GROUP_FIELD_MISSING_COLON,
     ...
     "insert a colon between the field name and the typename. Syntax: name: "
     "type [= expr];"},
    {GROUP_FIELD_TYPE_ERR, "An error occurred while parsing the type of field '{}'. Syntax: name: "
                           "type [= expr];"},
    ...
    {UNION_FIELD_MISSING_COLON,
     ...
     "insert a colon between the field name and the typename. Syntax: name: "
     "type [= expr];"},
    {UNION_FIELD_TYPE_ERR, "An error occurred while parsing the type of field '{}'. Syntax: name: "
                           "type [= expr];"},
    ...
    {TYPE_EXPECTED_TYPE, "Expected a type name after the open bracket. To fix the issue, insert a "
    ...
    {TYPE_EXPECTED_CLOSE_BRACKET,
     ...
     "[type; size]"},
    {TYPE_EXPECTED_CLOSE_BRACE, "Expected a close brace after the constant expression."},
    {EXPECTED_TYPE, "Failed to parse type. Expected a type name, but none was found. To fix "
                    "the issue, insert a type name"},
    {TYPE_EXPECTED_FUNCTION, "Expected a function name after the keyword 'fn'. To fix the issue, "
    ...
    {ENUM_EXPECTED_COLON, "Expected colon after the identifier in the enum declaration. To fix the "
    ...
    {FN_EXPECTED_CLOSE_PAREN_OR_COMMA,
     ...
     "parameter"},
    {FN_EXPECTED_OPEN_BRACE, "Expected an open brace after the function parameter list. To fix the "
    ...
    {FN_PARAM_PARSE_ERROR, "An error occurred while parsing the function parameter. To fix the "
    ...
    {FN_PARAM_TYPE_ERR, "An error occurred while parsing the type of parameter '{}'. Syntax: "
                        "name: type [= expr];"},
    {FN_PARAM_INIT_ERR, "Declaration of parameter '{}' requires an initializer, but an error "
                        "occurred while parsing the initializer. Syntax: name: type [= expr];"},
    {FN_EXPECTED_VARARG, "Expected '...' after the last parameter in the function parameter list. "
    ...
    {FN_NOEXCEPT_MULTIPLE,
     ...
     "the issue, remove the duplicate 'noexcept' specifier"},
    {FN_FOREIGN_MULTIPLE, "The 'foreign' specifier was already specified for this function. To fix "
                          "the issue, remove the duplicate 'foreign' specifier"},
    {FN_IMPURE_MULTIPLE, "The 'impure' specifier was already specified for this function. To fix "
                         "the issue, remove the duplicate 'impure' specifier"},
    {FN_TSAFE_MULTIPLE, "The 'tsafe' specifier was already specified for this function. To fix "
                        "the issue, remove the duplicate 'thread_safe' specifier"},
    {FN_PURE_MULTIPLE, "The 'pure' specifier was already specified for this function. To fix "
                       "the issue, remove the duplicate 'pure' specifier"},
    {FN_QUASIPURE_MULTIPLE, "The 'quasipure' specifier was already specified for this function. To "
                            "fix "
                            "the issue, remove the duplicate 'quasipure' specifier"},
    {FN_RETROPURE_MULTIPLE, "The 'retropure' specifier was already specified for this function. To "
                            "fix "
                            "the issue, remove the duplicate 'retropure' specifier"},
    {FN_INLINE_MULTIPLE, "The 'inline' specifier was already specified for this function. To fix "
                         "the issue, remove the duplicate 'inline' specifier"},
    {FN_PURE_IMPURE_MIX, "Conflicting function purity specifiers are illegal. To fix the issue, "
                         "remove the conflicting purity specifiers"},
    {FN_PURE_MIX, "Purity constraints are mutually exclusive. To fix the issue, remove the "
    ...
    {VAR_NAME_DUPLICATE, "Variable name '{}' is already in use. To fix the issue, rename the "
                         "variable to something unique"},
    {LET_NAME_DUPLICATE, "Variable name '{}' is already in use. To fix the issue, rename the "
                         "variable to something unique"},
    {CONST_NAME_DUPLICATE, "Variable name '{}' is already in use. To fix the issue, rename the "
                           "variable to something unique"},
    ...
    {UNION_NAME_DUPLICATE,
     ...
     "something unique"},
    {ENUM_NAME_DUPLICATE, "Enum name '{}' is already in use. To fix the issue, rename the enum to "
                          "something unique"},
    {FUNC_NAME_DUPLICATE, "Function name '{}' is already in use. To fix the issue, rename the "
    ...
    {ENUM_FIELD_DUPLICATE,
     "Field name '{}' is already in use. To fix the issue, rename the field to "
     "something unique"},
    {PARAM_NAME_DUPLICATE, "Parameter name '{}' is already in use. To fix the issue, rename the "
    ...
    {RETIF_MISSING_COMMA, "Expected a comma after the condition in the return-if statement. To fix "
    ...
    {RETZ_MISSING_COMMA, "Expected a comma after the condition in the return-zero statement. To "
    ...
    {RETV_MISSING_COMMA, "Expected a comma after the condition in the return-void statement. To "
    ...
    {FOR_EXPECTED_SEMICOLON, "Expected a semicolon after the for loop condition. To fix the issue, "
    ...
    {FORM_EXPECTED_IN, "Expected the keyword 'in' after the form name. To fix the issue, insert "
                       "the keyword 'in' after the form name. Syntax: form name in expr { ... "
                       "};"},
    {FORM_EXPECTED_EXPR, "Expected an expression after the keyword 'in'. To fix the issue, insert "
    ...
    {FOREACH_EXPECTED_IN, "Expected the keyword 'in' after the foreach name. To fix the issue, "
                          "insert "
    ...
    {ASM_EXPECTED_COMMA, "Expected a comma after the inline assembly statement. Syntax: __asm__ ( "
                         "\"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_OUTPUTS, "Expected an outputs list in the inline assembly statement. Syntax: "
                           "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_INPUTS, "Expected an inputs list in the inline assembly statement. Syntax: "
                          "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_CLOBBERS, "Expected a clobbers list in the inline assembly statement. Syntax: "
                            "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_RIGHT_PAREN,
     "Expected a closing parenthesis after the inline assembly statement. "
     "Syntax: __asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_SEMICOLON, "Expected a semicolon after the inline assembly statement. Syntax: "
                             "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_EXPECTED_LEFT_BRACE, "Expected an open brace after the inline assembly statement. Syntax: "
                              "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_PARAM_EXPECTED_STRING_LITERAL,
     "Expected a string literal in the inline assembly parameter list. Syntax: "
     "__asm__ ( \"mov x0, $0\", {}, {'$0': x}, [\"x0\"] );"},
    {ASM_PARAM_EXPECTED_COLON, "Expected a colon after the string literal in the inline assembly "
    ...
    {SWITCH_EXPECTED_COLON, "Expected a colon after the switch case'. To fix the issue, insert a "
                            "colon after the switch case"},
    {SWITCH_EXPECTED_CASE, "Expected a case statement after the switch keyword. To fix the issue, "
    ...
    {UNRESOLVED_FUNCTION, "Function '{}' is not defined in the current scope. To fix the issue, "
                          "define the function or import the module that defines the function"},
    {UNRESOLVED_TYPE, "Type '{}' is not defined in the current scope. To fix the issue, define "
