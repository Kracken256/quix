...
namespace qpkg
{
    namespace cache
    {
        ...
        public:
            ...
            inline CacheHasher &update(const std::vector<uint8_t> &data) { return update(data.data(), data.size()); }
        ...
        public:
             ...
             * @return true if the cache contains a value for the given key, false otherwise
             */
             ...
             * @throws std::out_of_range if the key is not in the cache
             */
            virtual std::chrono::system_clock::time_point timestamp(const CacheKey &key) = 0;
             ...
             */
            virtual void storeb(const CacheKey &key, const std::vector<uint8_t> &value) = 0;
