...
qpkg::core::LoggerStream::LoggerStream(
    std::ostringstream &stream, std::function<void(const std::string &)> flush)
    : m_stream(stream), m_flush(flush) {}

qpkg::core::LoggerStream &qpkg::core::LoggerStream::operator<<(
...
qpkg::core::ThreadLogger &qpkg::core::ThreadLogger::get(
    qpkg::core::Level level, qpkg::core::LoggerFlushCallback flush) {
  static thread_local std::map<Level, std::unique_ptr<ThreadLogger>>
      m_instances;
...
qpkg::core::ThreadLogger::ThreadLogger(qpkg::core::Level level,
                                       qpkg::core::LoggerFlushCallback flush)
    : m_flush(flush), m_level(level) {}

qpkg::core::ThreadLogger &qpkg::core::ThreadLogger::push(const std::string &msg,
                                                         float weight) {
...
qpkg::core::LoggerStream qpkg::core::ThreadLogger::stream(float weight) {
  return qpkg::core::LoggerStream(m_stream,
                                  [this, weight](const std::string &msg) {
                                    m_flush(msg, m_level, weight);
                                  });
}
...
void qpkg::core::GlobalCollector::setWriter(
    qpkg::core::LoggerFlushCallback new_flush) {
  m_flush = new_flush;
}

void qpkg::core::GlobalCollector::push(const std::string &msg,
...
qpkg::core::Process &qpkg::core::Process::debug(const std::string &msg,
                                                float weight) {
...
qpkg::core::Process &qpkg::core::Process::good(const std::string &msg,
                                               float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::Process &qpkg::core::Process::bold(const std::string &msg,
                                               float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::Process &qpkg::core::Process::info(const std::string &msg,
                                               float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::Process &qpkg::core::Process::warn(const std::string &msg,
                                               float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::Process &qpkg::core::Process::error(const std::string &msg,
                                                float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::Process &qpkg::core::Process::fatal(const std::string &msg,
                                                float weight) {
  m_phase = Phase::RUNNING;
...
qpkg::core::LoggerStream qpkg::core::Process::stream(qpkg::core::Level lvl,
                                                     float weight) {
  m_phase = Phase::RUNNING;
  switch (lvl) {
    case Level::DEBUG:
...
void qpkg::core::Process::done() { m_phase = Phase::HALTED; }

void qpkg::core::Process::operator+=(float weight) { info("", weight); }
