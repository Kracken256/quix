...
qpkg::core::LoggerStream::LoggerStream(std::ostringstream &stream,
...
qpkg::core::ThreadLogger &qpkg::core::ThreadLogger::get(qpkg::core::Level level,
...
qpkg::core::LoggerStream qpkg::core::ThreadLogger::stream(float weight) {
  return qpkg::core::LoggerStream(
      m_stream, [this, weight](const std::string &msg) { m_flush(msg, m_level, weight); });
}
...
void qpkg::core::GlobalCollector::push(const std::string &msg, qpkg::core::Level lvl,
                                       float weight) {
...
qpkg::core::Process::Process(const std::string &name) : m_name(name), m_phase(Phase::PENDING) {}

qpkg::core::Process qpkg::core::Process::create(const std::string &name) { return Process(name); }
