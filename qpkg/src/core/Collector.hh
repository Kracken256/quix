...
namespace qpkg
{
    namespace core
    {
        ...
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().debug().push(msg, weight); }
        };

        class Good
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().good().push(msg, weight); }
        };

        class Bold
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().bold().push(msg, weight); }
        };

        class Info
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().info().push(msg, weight); }
        };

        class Warn
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().warn().push(msg, weight); }
        };

        class Error
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().error().push(msg, weight); }
        };

        class Fatal
        {
        public:
            static void push(const std::string &msg, float weight = 0) { GlobalCollector::get().fatal().push(msg, weight); }
        };
